  ...
  return (
    <div className="ns-page">
      <PageTitle
        ...
        subtitle="Defect, containment, disposition, root-cause, and corrective-action records"
      />
      <nav className="ns-tabs" aria-label="Quality modules">
        ...
        <Link aria-current="page" href="/erp/quality/nonconformances">Nonconformances</Link>
        <Link href="/erp/quality/rtv">Returns to Vendor</Link>
      </nav>
      <RecordTable rows={rows} base="/erp/quality/nonconformances" />
    </div>
  );
}
